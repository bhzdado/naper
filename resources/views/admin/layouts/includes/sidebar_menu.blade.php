...
<ul class="nav sidebar-inner" id="sidebar-menu">
    <li  class="has-sub active expand" >
        <a class="sidenav-item-link" href="javascript:void(0)"  onclick="openRoute('dashboard');" data-toggle="collapse" data-target="#dashboard" aria-expanded="false" aria-controls="dashboard">
    ...
    <li  class="has-sub" >
        <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#permission"
           aria-expanded="false" aria-controls="permission">
            <i class="mdi mdi-pencil-box-multiple"></i>
            <span class="nav-text">Permissões e Perfis</span> <b class="caret"></b>
        </a>
        <ul  class="collapse"  id="permission" data-parent="#sidebar-menu">
            <div class="sub-menu">
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('permission');" data-toggle="collapse" data-target="#permission">
                        <span class="nav-text">Cadastro de Permissões</span>
                    </a>
                </li>
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('role');" data-toggle="collapse" data-target="#permission">
                        <span class="nav-text">Cadastro de Perfis</span>
                    </a>
                </li>
            </div>
        </ul>
    ...
    <li  class="has-sub" >
        <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#add"
           aria-expanded="false" aria-controls="add">
            <i class="mdi mdi-plus-box"></i>
            <span class="nav-text">Cadastros</span> <b class="caret"></b>
        </a>
        <ul  class="collapse"  id="add" data-parent="#sidebar-menu">
            <div class="sub-menu">
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('company');" data-toggle="collapse" data-target="#add">
                        <span class="nav-text">Empresas</span>
                    </a>
                </li>
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('user');"  data-toggle="collapse" data-target="#add">
                        <span class="nav-text">Usuários</span>
                    </a>
                </li>
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('menu');" data-toggle="collapse" data-target="#add">
    ...
    <li  class="has-sub" >
        <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#content"
           aria-expanded="false" aria-controls="content">
            ...
            <span class="nav-text">Conteúdos</span> <b class="caret"></b>
        </a>
        <ul  class="collapse"  id="content" data-parent="#sidebar-menu">
            <div class="sub-menu">
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('tribute');" data-toggle="collapse" data-target="#content">
                        <span class="nav-text">Impostos</span>
                    </a>
                </li>
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('module');"  data-toggle="collapse" data-target="#content">
                        <span class="nav-text">Módulos</span>
                    </a>
                </li>
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('content');" data-toggle="collapse" data-target="#content">
                        <span class="nav-text">Conteúdo</span>
                    </a>
                </li>
            </div>
        </ul>
    ...
    <li  class="has-sub" >
        <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#avaliacao" aria-expanded="false" aria-controls="avaliacao">
            <i class="mdi mdi-apps"></i>
            <span class="nav-text">Aplicativos</span> <b class="caret"></b>
        </a>
        <ul  class="collapse"  id="avaliacao" data-parent="#sidebar-menu">
            <div class="sub-menu">
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('avaliacao');" data-toggle="collapse" data-target="#avaliacao">
                        <span class="nav-text">Avaliações</span>
                    </a>
                </li>
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="alert('não implementado');"  data-toggle="collapse" data-target="#avaliacao">
    ...
    <li  class="has-sub" >
        ...
        <ul  class="collapse"  id="reports" data-parent="#sidebar-menu">
            <div class="sub-menu">
                <li >
                    <a class="sidenav-item-link" href="javascript:void(0)" onclick="openRoute('charts/show/usersAccess');" data-toggle="collapse" data-target="#reports">
                        <span class="nav-text">Acessos de Usuários</span>
                    </a>
                </li>
            </div>
        </ul>
