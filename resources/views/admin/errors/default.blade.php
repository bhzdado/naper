    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                ...
                <h2>Opps, encontramos um erro.</h2><br>
                <p style="font-size: 14px; font-weight: bold;">{{ $exception->getMessage() }} 
                    @IF (env('APP_ENV') == 'local')
                    <br><br><i> {{ $exception->getFile() }}: {{ $exception->getLine() }} </i>
                        @ENDIF
                </p>
                <button class="btn green">
                        <a href="#" onclick="Home();">
                            <span class="mdi mdi-home"></span> Página Inicial
                        </a>
                    </button>
            </div>
        </div>
